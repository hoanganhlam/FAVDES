...
from utils.location_checker import google_map_geo_coding, get_address, get_place_photos, get_places_nearby, \
    google_map_autocomplete, get_place
from utils.other import get_client_ip, convert_location, make_address
...
def fetch_address(request):
    ...
    if search:
        ...
        convert_location(search, address)
